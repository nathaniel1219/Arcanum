...
<body class="min-h-screen font-sans text-gray-800">
  ...
  <main class="p-8 max-w-7xl mx-auto">
    <div class="text-center mb-12">
      <h2 class="text-4xl font-bold mb-2">Yu-Gi-Oh! Cards</h2>
      <p class="text-gray-700 text-lg">Explore our exclusive Yu-Gi-Oh! collection</p>
    </div>
